...
<head>
    ...
    <style>
        ...
        header.site { display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 2rem; border-bottom: 1px solid #d9d2c5; padding-bottom: 1rem; }
        ...
        article :is(h2,h3) { font-family: "Segoe UI", sans-serif; color: #0f172a; margin-top: 2rem; }
        article img { max-width: 100%; height: auto; border-radius: 12px; }
        article a { color: #0b3d91; }
...
<body>
    <div class="wrap">
        <header class="site">
            <a href="{{ rtrim(config('app.url') ?: 'https://www.sisgesc.net', '/') }}">SIGESC</a>
            <a href="{{ route('blog.posts') }}">Blog</a>
        </header>
        @yield('content')
        <footer>
