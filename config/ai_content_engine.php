...
$topicBuckets = [
    'fiscal' => [
        ...
        'queries' => [
            ...
            'software faturação eletrónica certificado AGT Angola',
            'série e numeração de faturas Angola regras AGT',
            'nota de crédito e débito Angola faturação',
            'regime de IVA exclusão isenção Angola PME',
            'Imposto de Selo Angola contratos e recibos',
            'obrigação de emitir fatura eletrónica Angola 2026',
            'como corrigir fatura emitida AGT Angola',
            'arquivo digital documentos fiscais Angola prazos',
            'IVA nas importações Angola desembaraço aduaneiro',
            'multas e infracções fiscais AGT Angola PME',
        ],
    ],
    'gestao' => [
        ...
        'queries' => [
            ...
            'gestão de compras e fornecedores PME Angola',
            'controlo de stock multi-armazém Angola',
            'PDV multi-pagamentos Multicaixa TPA Angola',
            'como organizar folha de pagamento PME Angola',
            'controlo de ponto funcionários pequena empresa',
            'promoções e descontos no PDV Angola',
            'gestão financeira dashboard contas bancárias PME',
            'agenda online marcações salão clínica Angola',
            'logística entregas frota PME Luanda',
            'como reduzir ruturas de stock loja Angola',
            'KPI vendas e margem para PME angolana',
            'transferência de produtos entre armazéns Angola',
        ],
    ],
    'marketing' => [
        ...
        'queries' => [
            ...
            'email marketing PME Angola boas práticas',
            'Google Merchant Center loja Angola',
            'catálogo digital WhatsApp para loja Angola',
            'como criar funil de vendas PME Angola',
            'conteúdo para Instagram loja Angola engajamento',
            'SEO local Google Meu Negócio Luanda PME',
            'vendas por Instagram Direct Angola conversão',
            'marketplace vs loja própria Angola PME',
            'retenção de clientes programa fidelidade Angola',
            'fotografia de produto para anúncios Angola',
        ],
    ],
    'empreendedorismo' => [
        ...
        'queries' => [
            ...
            'abrir loja de roupa Angola custos e licenças',
            'gestão de oficina mecânica Angola stock peças',
            'abrir clínica privada Angola requisitos',
            'distribuição grossista Angola gestão stock',
            'câmbio e remessas para importadores Angola',
            'plano de negócio PME Angola modelo simples',
            'como escolher local comercial Luanda PME',
            'seguros para pequena empresa Angola',
            'parcerias e franchising Angola oportunidades',
            'transformar negócio familiar em empresa formal Angola',
        ],
    ],
];
...
return [
    ...
    */
    'search_interest' => [
        ...
        'bucket_keywords' => [
            'fiscal' => ['agt', 'iva', 'irt', 'imposto', 'fatura', 'nif', 'tribut', 'selo', 'retenção'],
            'gestao' => ['erp', 'crm', 'pdv', 'stock', 'gestão', 'gestao', 'software', 'caixa', 'folha', 'logística', 'compra'],
            'marketing' => ['facebook', 'instagram', 'whatsapp', 'anúncio', 'ads', 'loja', 'e-commerce', 'marketing', 'catálogo'],
            'empreendedorismo' => ['empresa', 'licen', 'inapem', 'crédito', 'credito', 'import', 'export', 'farmácia', 'restaurante'],
        ],
        'bucket_stems' => [
            'fiscal' => [
                'IVA Angola',
                ...
                'IRT Angola',
                'NIF empresa Angola',
                'documento fiscal eletrónico Angola',
                'Imposto de Selo Angola',
            ],
            'gestao' => [
                ...
                'folha de pagamento Angola',
                'gestão de compras Angola',
                'logística entregas Luanda',
            ],
            'marketing' => [
                'loja online Angola',
                'Facebook Ads Angola',
                ...
                'email marketing Angola',
                'Google Merchant Center Angola',
            ],
            'empreendedorismo' => [
