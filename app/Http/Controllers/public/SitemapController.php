...
class SitemapController extends Controller
{
    public function index(): Response
    {
        ...
        $staticUrls = [
            ...
            ['loc' => route('partnership.index', absolute: true), 'changefreq' => 'monthly', 'priority' => '0.9'],
            ['loc' => route('about.index', absolute: true), 'changefreq' => 'monthly', 'priority' => '0.9'],
            ['loc' => $base.'/llms.txt', 'changefreq' => 'monthly', 'priority' => '0.5'],
            ['loc' => $base.'/llms-full.txt', 'changefreq' => 'monthly', 'priority' => '0.5'],
            ['loc' => $base.'/ai.txt', 'changefreq' => 'monthly', 'priority' => '0.4'],
            ['loc' => $base.'/agents.md', 'changefreq' => 'monthly', 'priority' => '0.4'],
            ['loc' => $base.'/humans.txt', 'changefreq' => 'yearly', 'priority' => '0.3'],
            ['loc' => $base.'/.well-known/security.txt', 'changefreq' => 'yearly', 'priority' => '0.2'],
            ['loc' => $base.'/.well-known/ai-plugin.json', 'changefreq' => 'yearly', 'priority' => '0.3'],
