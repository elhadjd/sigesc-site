...
function SuccessStoriesPage(props) {
  ...
  return /* @__PURE__ */ jsx(UserLoggedProvider, { children: /* @__PURE__ */ jsxs(FormStateProvider, { children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "pt-12 pb-20 bg-gradient-to-br from-blue-50 to-indigo-50 sm:pt-16", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: /* @__PURE__ */ jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 30 },
