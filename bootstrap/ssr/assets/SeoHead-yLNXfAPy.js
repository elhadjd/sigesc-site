...
function SeoHead({ seo, fallbackTitle, fallbackDescription }) {
  ...
  return /* @__PURE__ */ jsxs(Helmet, { children: [
    ...
    /* @__PURE__ */ jsx("meta", { name: "geo.region", content: "AO" }),
    /* @__PURE__ */ jsx("meta", { name: "language", content: "pt-AO" }),
    /* @__PURE__ */ jsx(
      "meta",
      {
        name: "agt:certification",
        content: (seo == null ? void 0 : seo.agt_certification_number) || "FE/323/AGT/2026"
      }
    ),
    ((seo == null ? void 0 : seo.geo_links) || []).map((link) => /* @__PURE__ */ jsx(
      "link",
      {
    ...
    ((seo == null ? void 0 : seo.json_ld) || []).map((block, index) => /* @__PURE__ */ jsx("script", { type: "application/ld+json", children: JSON.stringify(block) }, index))
  ] });
}
export {
  SeoHead as S
