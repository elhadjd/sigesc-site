    ...
    /* @__PURE__ */ jsxs("main", { className: "partnership-page bg-[#071820] text-white", children: [
          ...
          /* @__PURE__ */ jsxs(
            motion.p,
            {
              ...
              children: [
                ...
                "/mês com 10 licenças. Freelancer: indique clientes e ganhe ",
                commission,
                " de comissão."
              ]
            }
          ...
          /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "mt-4 text-white/80", children: "10 licenças inclusas (cloud e offline)" }),
                ...
                /* @__PURE__ */ jsx(
                  Link,
                  {
                    ...
                    children: "Quero ser parceiro (10 licenças)"
                  }
                )
              ]
            }
      ...
      /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden border-t border-white/10", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative mx-auto max-w-6xl px-4 py-16 sm:px-6", children: [
          /* @__PURE__ */ jsx("h2", { className: "font-serif text-3xl text-white sm:text-4xl", children: "10 licenças para parceiros" }),
          /* @__PURE__ */ jsx("p", { className: "mt-4 max-w-2xl text-lg text-white/75", children: "No plano Parceiro, você recebe 10 licenças (cloud e offline) — ideais para começar a sua carteira de clientes em Angola." }),
