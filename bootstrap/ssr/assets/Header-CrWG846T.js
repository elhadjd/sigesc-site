...
const HeaderComponent = ({ auth }) => {
  ...
  return /* @__PURE__ */ jsxs(
    motion.header,
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "bg-[#0b3d91] text-white", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-x-3 gap-y-1 px-4 py-1.5 text-center text-[11px] font-semibold tracking-wide sm:justify-between sm:text-xs sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "rounded bg-white/15 px-2 py-0.5 uppercase tracking-[0.14em]", children: SIGESC_AGT_CERT_LABEL }),
            /* @__PURE__ */ jsx("span", { className: "hidden text-sky-100 sm:inline", children: "Faturação eletrónica · Angola" })
          ] }),
          /* @__PURE__ */ jsx("span", { className: "font-mono text-sm font-bold tracking-wider text-amber-200 sm:text-base", children: SIGESC_AGT_CERT_NUMBER })
        ] }) }),
          ...
          /* @__PURE__ */ jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
                /* @__PURE__ */ jsxs("div", { className: "mb-4 rounded-xl bg-[#0b3d91] px-3 py-2 text-center text-white", children: [
                  /* @__PURE__ */ jsx("p", { className: "text-[10px] font-semibold uppercase tracking-[0.14em] text-sky-100", children: SIGESC_AGT_CERT_LABEL }),
                  /* @__PURE__ */ jsx("p", { className: "mt-0.5 font-mono text-sm font-bold tracking-wider text-amber-200", children: SIGESC_AGT_CERT_NUMBER })
                ] }),
