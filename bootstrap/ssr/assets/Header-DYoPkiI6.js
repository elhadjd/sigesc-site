...
import { BsPhone, BsFacebook, BsCash, BsBuilding, BsTag, BsCalculator, BsQuestionCircle, BsPerson, BsShop, BsFileEarmarkText, BsChatDots } from "react-icons/bs";
import { FaDownload, FaUsers, FaTools, FaRegNewspaper, FaRobot } from "react-icons/fa";
import { Link, usePage } from "@inertiajs/react";
import { u as useStateChatToggle, a as useLoggedUser } from "./loggedUser-DyDIPP3j.js";
...
const SIGESC_SITE_URL = "https://sisgesc.net";
...
const SIGESC_AGT_CERT_NUMBER = "FE/323/AGT/2026";
const SIGESC_AGT_CERT_LABEL = "Software certificado AGT";
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "lg:pr-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mb-6 rounded-xl border border-amber-200 bg-amber-50 px-3 py-2.5", children: [
            /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold uppercase tracking-[0.14em] text-amber-800", children: SIGESC_AGT_CERT_LABEL }),
            /* @__PURE__ */ jsx("p", { className: "mt-0.5 font-mono text-sm font-bold tracking-wider text-[#0b3d91]", children: SIGESC_AGT_CERT_NUMBER })
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("ul", { className: "space-y-3", children: [
            ...
            /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: "/gerador-de-fatura", className: "flex items-center gap-3 text-gray-600 hover:text-blue-500 transition-colors duration-300 group", children: /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Criar fatura online" }) }) }),
            /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: "/gerador-de-codigo-barras", className: "flex items-center gap-3 text-gray-600 hover:text-blue-500 transition-colors duration-300 group", children: /* @__PURE__ */ jsx("span", { className: "text-sm", children: "QR e código de barras" }) }) }),
            ...
            /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(Link, { href: "/parceria", className: "flex items-center gap-3 text-gray-600 hover:text-blue-500 transition-colors duration-300 group", children: [
              /* @__PURE__ */ jsx(FaUsers, { className: "text-blue-500 group-hover:scale-110 transition-transform" }),
              /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Parceria · 40.000 Kz/mês" })
            ] }) }),
            /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: "/sobre", className: "flex items-center gap-3 text-gray-600 hover:text-blue-500 transition-colors duration-300 group", children: /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Sobre o SIGESC" }) }) }),
      ...
      /* @__PURE__ */ jsx("div", { className: "pt-6 border-t border-gray-200", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row justify-between items-center", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-gray-500 text-xs md:justify-end", children: [
          /* @__PURE__ */ jsx("span", { children: "NIF: 5000659738" }),
          /* @__PURE__ */ jsx("span", { className: "hidden sm:inline", children: "•" }),
          /* @__PURE__ */ jsx("span", { className: "font-mono font-semibold text-[#0b3d91]", children: SIGESC_AGT_CERT_NUMBER }),
          /* @__PURE__ */ jsx("span", { className: "hidden sm:inline", children: "•" }),
          /* @__PURE__ */ jsx("span", { children: "Feito para o seu negócio" })
        ] })
      ] }) })
    ] })
  ] });
...
const NAV_LINK = "inline-flex h-9 items-center gap-1.5 rounded-md px-2.5 text-[13px] font-medium leading-none text-slate-700 transition-colors hover:bg-slate-50 hover:text-[#00a5cf]";
const MOBILE_LINK = "flex min-h-11 items-center gap-3 rounded-lg px-3 text-[15px] font-medium leading-none text-slate-700 transition-colors hover:bg-sky-50 hover:text-[#00a5cf]";
const DROPDOWN_LINK = "block px-3.5 py-2.5 text-[13px] font-medium leading-snug text-slate-700 transition-colors hover:bg-sky-50 hover:text-[#00a5cf]";
const HeaderComponent = ({ auth }) => {
  ...
  const primaryItems = [
    {
      href: "/solutions",
      icon: /* @__PURE__ */ jsx(FaTools, { className: ICON }),
      text: "Soluções",
      dropdown: solutionItems
    },
    { href: "/prices", icon: /* @__PURE__ */ jsx(BsTag, { className: ICON }), text: "Preços" },
    { href: "/parceria", icon: /* @__PURE__ */ jsx(BsBuilding, { className: ICON }), text: "Parceria" },
    { href: "/blog/posts", icon: /* @__PURE__ */ jsx(FaRegNewspaper, { className: ICON }), text: "Blog" },
    {
      href: "/calculadoras",
      icon: /* @__PURE__ */ jsx(BsCalculator, { className: ICON }),
      text: "Ferramentas",
      dropdown: toolItems
    },
    { href: "/sobre", icon: /* @__PURE__ */ jsx(BsQuestionCircle, { className: ICON }), text: "Sobre" },
    { href: "/clients/depoiments", icon: /* @__PURE__ */ jsx(BsPerson, { className: ICON }), text: "Clientes" },
    { href: route("shop", { page: "" }), icon: /* @__PURE__ */ jsx(BsShop, { className: ICON }), text: "Loja" }
  ];
  if (canAccessAiContent) {
    primaryItems.push({
      href: "/admin/ai-content",
      icon: /* @__PURE__ */ jsx(FaRobot, { className: ICON }),
      text: "AI Content"
    });
  }
  const mobileItems = [
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsx(BsFileEarmarkText, { className: ICON }),
      text: "Criar fatura"
    },
    {
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsx(BsChatDots, { className: ICON }),
      text: "Especialista"
    }
  ];
  const supportItems = [
    { href: "/contact", icon: /* @__PURE__ */ jsx(RiCustomerService2Line, { className: ICON }), text: "Suporte" },
    { href: route("download-page"), icon: /* @__PURE__ */ jsx(FaDownload$1, { className: ICON }), text: "Downloads" },
    { href: route("resources", { resource: "help" }), icon: /* @__PURE__ */ jsx(BsQuestionCircle, { className: ICON }), text: "Ajuda" }
  ];
  ...
  const NavLink = ({
    ...
    const content = /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("span", { className: "inline-flex shrink-0 text-current", children: item.icon }),
      /* @__PURE__ */ jsx("span", { className: "truncate", children: item.text })
    ] });
    if (isExternal) {
      return /* @__PURE__ */ jsx("a", { href: item.href, className, onClick, children: content });
    }
    return /* @__PURE__ */ jsx(Link, { href: item.href, className, onClick, children: content });
  };
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(
      motion.header,
      {
        className: `fixed inset-x-0 top-0 z-50 border-b transition-colors duration-300 ${isScrolled ? "border-slate-200/80 bg-white/95 shadow-sm backdrop-blur" : "border-slate-100 bg-white"}`,
        initial: { opacity: 0, y: -12 },
        animate: { opacity: 1, y: 0 },
        transition: { duration: 0.35, ease: "easeOut" },
        children: [
          /* @__PURE__ */ jsx("div", { className: "h-9 bg-[#0b3d91] text-white", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex h-full max-w-7xl items-center justify-between gap-3 px-4 sm:px-6 lg:px-8", children: [
            /* @__PURE__ */ jsxs("span", { className: "inline-flex min-w-0 items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.12em]", children: [
              /* @__PURE__ */ jsx("span", { className: "truncate rounded bg-white/15 px-2 py-0.5", children: SIGESC_AGT_CERT_LABEL }),
              /* @__PURE__ */ jsx("span", { className: "hidden truncate text-[11px] font-medium normal-case tracking-normal text-sky-100 sm:inline", children: "Faturação eletrónica · Angola" })
            ] }),
            /* @__PURE__ */ jsx("span", { className: "shrink-0 font-mono text-[12px] font-bold tracking-wider text-amber-200 sm:text-[13px]", children: SIGESC_AGT_CERT_NUMBER })
          ] }) }),
          /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "flex h-14 items-center justify-between gap-3 sm:h-16", children: [
            /* @__PURE__ */ jsxs(Link, { href: "/", className: "group flex min-w-0 shrink-0 items-center gap-2", onClick: closeMenu, children: [
              /* @__PURE__ */ jsx("span", { className: "inline-flex h-9 w-9 items-center justify-center rounded-lg bg-[#00a5cf] text-[15px] font-bold text-white transition-colors group-hover:bg-[#0090b5]", children: "S" }),
              /* @__PURE__ */ jsx("span", { className: "text-[17px] font-bold leading-none tracking-tight text-slate-900 sm:text-[18px]", children: "IGESC" }),
              /* @__PURE__ */ jsx(
                "span",
                {
                  ...
                  children: SIGESC_AGT_CERT_NUMBER
                }
              )
            ] }),
            /* @__PURE__ */ jsx(
              "nav",
              {
                ...
                children: primaryItems.map((item) => /* @__PURE__ */ jsxs(
                  "div",
                  {
                    className: "relative",
                    onMouseEnter: () => setOpenDesktopMenu(item.dropdown ? item.text : null),
                    children: [
                      item.dropdown ? /* @__PURE__ */ jsxs("a", { href: item.href, className: NAV_LINK, children: [
                        /* @__PURE__ */ jsx("span", { className: "inline-flex shrink-0", children: item.icon }),
                        /* @__PURE__ */ jsx("span", { children: item.text }),
                        /* @__PURE__ */ jsx(
                          AiOutlineDown,
                          {
                            className: `h-3 w-3 shrink-0 transition-transform ${openDesktopMenu === item.text ? "rotate-180" : ""}`
                          }
                        )
                      ] }) : /* @__PURE__ */ jsx(NavLink, { item, className: NAV_LINK }),
                      item.dropdown && openDesktopMenu === item.text && /* @__PURE__ */ jsx("div", { className: "absolute left-0 top-full z-50 pt-1", children: /* @__PURE__ */ jsx("div", { className: "w-64 overflow-hidden rounded-lg border border-slate-200 bg-white py-1 shadow-lg", children: item.dropdown.map((dropdownItem) => /* @__PURE__ */ jsx(
                        "a",
                        {
                        ...
                        dropdownItem.href + dropdownItem.name
                      )) }) })
                    ]
                  },
                  item.text
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex shrink-0 items-center gap-1.5 sm:gap-2", children: [
              /* @__PURE__ */ jsx("div", { className: "hidden items-center gap-0.5 md:flex", children: supportItems.map((item) => /* @__PURE__ */ jsx(
                Link,
                {
                  href: item.href,
              ...
              (user == null ? void 0 : user.id) ? /* @__PURE__ */ jsx(Link, { href: "/profile", className: "inline-flex h-9 w-9 items-center justify-center", children: /* @__PURE__ */ jsx(
                "img",
                {
                  src: ((_a = user.user_profile) == null ? void 0 : _a.image) || "/img/avatar-placeholder.svg",
                  alt: "Perfil",
              ...
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  type: "button",
                  children: isMenuOpen ? /* @__PURE__ */ jsx(AiOutlineClose, { className: "h-5 w-5" }) : /* @__PURE__ */ jsx(AiOutlineMenu, { className: "h-5 w-5" })
                }
              )
            ] })
          ] }) })
    ...
    /* @__PURE__ */ jsx("div", { className: "h-[5.75rem] sm:h-[6.25rem]", "aria-hidden": "true" }),
    /* @__PURE__ */ jsx(AnimatePresence, { children: isMenuOpen && /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs(
        motion.aside,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex h-14 items-center justify-between border-b border-slate-100 px-4", children: [
              /* @__PURE__ */ jsxs(Link, { href: "/", className: "flex items-center gap-2", onClick: closeMenu, children: [
                /* @__PURE__ */ jsx("span", { className: "inline-flex h-9 w-9 items-center justify-center rounded-lg bg-[#00a5cf] text-[15px] font-bold text-white", children: "S" }),
                /* @__PURE__ */ jsx("span", { className: "text-[17px] font-bold leading-none text-slate-900", children: "IGESC" })
              ] }),
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  "aria-label": "Fechar",
                  children: /* @__PURE__ */ jsx(AiOutlineClose, { className: "h-5 w-5" })
                }
              )
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "border-b border-slate-100 bg-[#0b3d91] px-4 py-3 text-center text-white", children: [
              /* @__PURE__ */ jsx("p", { className: "text-[11px] font-semibold uppercase tracking-[0.12em] text-sky-100", children: SIGESC_AGT_CERT_LABEL }),
              /* @__PURE__ */ jsx("p", { className: "mt-1 font-mono text-[13px] font-bold tracking-wider text-amber-200", children: SIGESC_AGT_CERT_NUMBER })
            ] }),
            /* @__PURE__ */ jsxs("nav", { className: "flex-1 overflow-y-auto overscroll-contain px-3 py-3", "aria-label": "Mobile", children: [
              /* @__PURE__ */ jsx("div", { className: "space-y-0.5", children: mobileItems.map((item) => /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(NavLink, { item, className: MOBILE_LINK, onClick: closeMenu }),
                item.dropdown && /* @__PURE__ */ jsx("div", { className: "mb-1 ml-8 space-y-0.5 border-l border-slate-200 pl-3", children: item.dropdown.map((dropdownItem) => /* @__PURE__ */ jsx(
                  Link,
                  {
                    href: dropdownItem.href,
              ...
              /* @__PURE__ */ jsxs("div", { className: "mt-4 border-t border-slate-200 pt-3", children: [
                /* @__PURE__ */ jsx("p", { className: "mb-1 px-3 text-[11px] font-semibold uppercase tracking-[0.14em] text-slate-400", children: "Recursos" }),
                supportItems.map((item) => /* @__PURE__ */ jsxs(
                  Link,
                  {
                    ...
                    onClick: closeMenu,
                    children: [
                      /* @__PURE__ */ jsx("span", { className: "inline-flex shrink-0 text-[#00a5cf]", children: item.icon }),
                      /* @__PURE__ */ jsx("span", { children: item.text })
                    ]
                  },
                  item.text
              ...
              !(user == null ? void 0 : user.id) && /* @__PURE__ */ jsxs("div", { className: "mt-4 space-y-2 border-t border-slate-200 pt-4", children: [
                /* @__PURE__ */ jsx(
                  "a",
                  {
                    href: SIGESC_ADMIN_LOGIN_URL,
...
export {
  ...
  SIGESC_GETTING_STARTED_URL as a,
  SIGESC_SITE_URL as b,
