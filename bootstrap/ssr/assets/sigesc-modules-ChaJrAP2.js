...
import { m as moduleData, a as SIGESC_SITE_URL, H as HeaderComponent, b as SIGESC_GETTING_STARTED_URL, F as FooterComponent } from "./Header-0-Q0W_KU.js";
...
function ModulePage(props) {
  ...
  return /* @__PURE__ */ jsx(UserLoggedProvider, { children: /* @__PURE__ */ jsxs(FormStateProvider, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 pt-8 pb-16 sm:pt-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
