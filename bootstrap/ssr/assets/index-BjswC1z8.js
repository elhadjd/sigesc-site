    ...
    /* @__PURE__ */ jsxs("main", { className: "bg-[#f3f0ea]", children: [
      /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden border-b border-black/5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative mx-auto max-w-5xl px-4 py-14 sm:px-6", children: [
          /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-[0.2em] text-[#0b3d91]", children: "SIGESC · Ferramentas legais" }),
          /* @__PURE__ */ jsx("h1", { className: "mt-3 font-serif text-4xl text-[#14213d] sm:text-5xl", children: "Calculadoras fiscais de Angola" }),
          /* @__PURE__ */ jsxs("p", { className: "mt-4 max-w-2xl text-lg text-slate-600", children: [
            "Cálculos feitos no servidor com bcmath, usando taxas da legislação configurada (vigência ",
            meta.effective_from,
            "). Sem arredondamentos “à mão” no browser."
          ] })
        ] })
      ] }),
