...
import { f as features, p as performanceMetrics, H as HeaderComponent, F as FooterComponent } from "./Header-DYoPkiI6.js";
...
const Apps = React.lazy(() => import("./apps-DXHGAsd6.js"));
const Cards = React.lazy(() => import("./Cards-DUqv6QQS.js"));
const Contacts = React.lazy(() => import("./index-BUg1uR8k.js"));
const BecomePartnerSection = React.lazy(() => import("./PartnerSection-BaDX3jCM.js"));
...
const Demonstration = ({ auth }) => {
  ...
  return /* @__PURE__ */ jsxs("main", { className: "bg-gray-50", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative bg-gradient-to-br from-slate-50 via-white to-slate-100 pt-8 sm:pt-10 overflow-hidden", children: [
