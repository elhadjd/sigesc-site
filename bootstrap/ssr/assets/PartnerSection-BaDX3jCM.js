    ...
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mx-auto mt-4 max-w-2xl text-white/75", children: "Parceria Parceiro por 40.000 Kz/mês com licenças ilimitadas, ou Freelancer com 30% de comissão por indicação de clientes — suporte e crescimento junto de PME em Angola." }),
